...
all: unit-tests example-workload image-example-workload lint
...
.PHONY: $(ARTIFACTS)/example-workload-linux-amd64
$(ARTIFACTS)/example-workload-linux-amd64:
	@$(MAKE) local-example-workload-linux-amd64 DEST=$(ARTIFACTS)

.PHONY: example-workload-linux-amd64
example-workload-linux-amd64: $(ARTIFACTS)/example-workload-linux-amd64  ## Builds executable for example-workload-linux-amd64.

.PHONY: $(ARTIFACTS)/example-workload-linux-arm64
$(ARTIFACTS)/example-workload-linux-arm64:
	@$(MAKE) local-example-workload-linux-arm64 DEST=$(ARTIFACTS)

.PHONY: example-workload-linux-arm64
example-workload-linux-arm64: $(ARTIFACTS)/example-workload-linux-arm64  ## Builds executable for example-workload-linux-arm64.

.PHONY: example-workload
example-workload: example-workload-linux-amd64 example-workload-linux-arm64  ## Builds executables for example-workload.
...
.PHONY: image-example-workload
image-example-workload:  ## Builds image for example-workload.
	@$(MAKE) registry-$@ IMAGE_NAME="example-workload"
